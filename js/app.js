            ...
            services.directions.set.route(request, function (response, status) {
                        if (status == google.maps.DirectionsStatus.OK) {
                            ...
                            for (var i = 0; i < myRoute.steps.length; i++) {
                                Map.marker(myRoute.steps[i].start_location, myRoute.steps[i].instructions); << << << < HEAD
                                // console.log("Marker " + i + " : " + myRoute.steps[i].start_location);
                            };
                            line ? line.setMap(null) : null; === === =
                        } >>> >>> > d232a4765197a9db475af06487150a93d5d600b5
                        var lineSymbol = {
                            path: 'M 0,-1 0,1',
                            strokeOpacity: 1,
                            scale: 4
                        ...
                        line = new google.maps.Polyline({ === === =
                                ...
                                lastLeg = new google.maps.Polyline({ >>> >>> > d232a4765197a9db475af06487150a93d5d600b5
